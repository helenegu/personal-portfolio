      ...
      top-0 z-20 bg-primary`}>
        <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
          ...
          >
            ...
            <p className="text-white text-[18px] font-bold cursor-pointer flex">Helene Gu &nbsp;
              <span className="sm:block hidden">Personal Portfolio
              </span>
            </p>
          </Link>
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
            ...
            top-20 right-0 mx-4 my-2 min-w-[14-px] 
            z-10 rounded-xl`}>
