  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-[#eaddfd]`}>★
          <span className={`${styles.heroHeadText} text-white`}>
            &nbsp; Hi, I'm </span>
            <span className="text-[#d188f2]"> &nbsp;Helene</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2
          text-white-100`}>
            I study Data Science <br className="sm:block hidden"/> at Duke Kunshan University.
          </p>
        </div>
       </div>
